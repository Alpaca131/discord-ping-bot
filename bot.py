...
async def on_message(message):
    if message.content == 'd.help':
        ...
        await message.channel.send('Discordの現在のPingは___**' + str(latency) + 'ms**___です！')
        return
        ...
        embed = discord.Embed(title='このサーバーのリージョン：' + str(message.guild.region), color=discord.Color.blue())
